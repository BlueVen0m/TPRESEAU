...
<!DOCTYPE html>
   ...
   <title>Ajouter un lot</title>
    ...
    <a href="./user_home.php" class="btn btn-danger m-2">Retour<a>
    ...
    <div class="col-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="./user_objet.php?id=<?php echo htmlspecialchars($objet[$i]["id"]) ?>" class="btn btn-sm btn-success">Contenu</a>
            </div>
        </div>
    </div>
    <?php
